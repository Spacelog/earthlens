...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Image.in_group'
        db.add_column(u'core_image', 'in_group',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Image.group_hides'
        db.add_column(u'core_image', 'group_hides',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Image.in_group'
        db.delete_column(u'core_image', 'in_group')

        # Deleting field 'Image.group_hides'
        db.delete_column(u'core_image', 'group_hides')
