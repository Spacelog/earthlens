...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserTag.date'
        db.add_column(u'core_usertag', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'ImageVote.date'
        db.add_column(u'core_imagevote', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserTag.date'
        db.delete_column(u'core_usertag', 'date')

        # Deleting field 'ImageVote.date'
        db.delete_column(u'core_imagevote', 'date')
