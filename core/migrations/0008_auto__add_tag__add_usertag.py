...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_tag', (
            ...
            ('descriptive_image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Image'], null=True)),
        ))
        ...
        db.create_table(u'core_usertag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tag_objects', to=orm['auth.User'])),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Image'])),
            ('tagged', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Tag'])),
        ))
        db.send_create_signal(u'core', ['UserTag'])
