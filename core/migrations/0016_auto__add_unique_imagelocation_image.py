...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ImageLocation', fields ['image']
        db.create_unique(u'core_imagelocation', ['image_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ImageLocation', fields ['image']
        db.delete_unique(u'core_imagelocation', ['image_id'])
    ...
    models = {
        ...
        u'core.imagelocation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Image']", 'unique': 'True'}),
